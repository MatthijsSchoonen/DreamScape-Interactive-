...
namespace DreamScape.Views
    {
        ...
        private void LoadTrades()
        {
            ...
            {
                var loggedInUserId = MainWindow.LoggedInUser.Id;

                var trades = dbContext.Trades
                    .Include(t => t.Seller)
                    .Include(t => t.Buyer)
                    .Include(t => t.status)
                    .Where(t => t.SellerId == loggedInUserId || t.BuyerId == loggedInUserId)
                    .ToList();
        ...
        private void StatusFilterComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e)
            ...
            private async void DeleteTrade_Click(object sender, RoutedEventArgs e)
            {
                ...
                if (trade != null && trade.BuyerId == MainWindow.LoggedInUser.Id)
                {
                    ...
                    await emailHelper.SendEmailAsync(trade.Seller.Email, "Trade Deleted", "The trade has been deleted by the buyer.");
                    LoadTrades();
                }
            }
            ...
            private async void AcceptTrade_Click(object sender, RoutedEventArgs e)
            {
                ...
                if (trade != null && trade.SellerId == MainWindow.LoggedInUser.Id && trade.StatusId == 1) // Assuming 1 is the pending status
                {
                    ...
                    await emailHelper.SendEmailAsync(trade.Buyer.Email, "Trade Accepted", "The trade has been accepted by the seller.");
                    LoadTrades();
                }
            }
            ...
            private async void DeclineTrade_Click(object sender, RoutedEventArgs e)
            {
                ...
                if (trade != null && trade.SellerId == MainWindow.LoggedInUser.Id && trade.StatusId == 1) // Assuming 1 is the pending status
                {
                    ...
                    await emailHelper.SendEmailAsync(trade.Buyer.Email, "Trade Declined", "The trade has been declined by the seller.");
                    LoadTrades();
                }
            }
